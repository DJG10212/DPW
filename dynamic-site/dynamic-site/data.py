class Data(object):
    ...
    def movie_name(self, new_movie_name):
        ...
        if self._movie_name == "Jurassic World":
            ...
            self._movie._box_office = "$208,806,270"
            ...
            self._movie._box_office = "$207,438,708"
            self._movie._description = "Earth's mightiest heroes must come together and learn to fight as a team if they are to stop the mischievous Loki and his alien army from enslaving humanity."
        ...
        elif self._movie_name == "Age of Ultron":
            self._movie._title = self._movie_name
            self._movie._director = "Joss Whedon"
            self._movie._box_office = "$191,271,1090"
            ...
            self._movie._box_office = "$174,144,585"
        ...
        elif self._movie_name == "The Dark Knight Rises":
            self._movie._title = self._movie_name
            self._movie._director = "Christopher Nolan"
            self._movie._box_office = "$160,887,295"
...
class Movie(Data):
    def __init__(self):
        ...
        self._box_office = None  # movies box office weekend total
